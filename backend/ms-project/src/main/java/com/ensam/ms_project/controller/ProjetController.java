...
public class ProjetController {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> createProjet(@RequestBody ProjetRequestDTO projetDTO, @RequestParam Role role){
        try{
            return ResponseEntity.ok(projetService.createProjet(projetDTO,role));
